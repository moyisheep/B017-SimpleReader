...
public:
    ...
    void SetHighlight(size_t target);
...
private:
    ...
    int m_curTarget = 0;
    int m_curHover = -1;
    std::wstring m_font_family = L"Microsoft YaHei";
    COLORREF m_highlight_color = RGB(238, 165, 102);  // #eea566
    COLORREF m_hover_color = RGB(240, 240, 240);
